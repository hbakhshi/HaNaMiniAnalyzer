...
class BinDatacard :
    def __init__(self, BinName  , EffPlotName = None ):
        ...
        self.HiggsSamples = {}
        self.HiggsSamples["thq"] = DatasetInfo("thq" , "../../signals/13May/out_ctcv_thq_syst.root", "ctcv", "RVthq_mh125" , "2dPlots.root" ,   EffPlotName, 0.99999 , 1.00001 )
        self.HiggsSamples["thw"] = DatasetInfo("thw" , "../../signals/13May/out_ctcv_thw_syst.root", "ctcv", "RVthw_mh125" ,  "2dPlots.root" ,  EffPlotName, 0.99999 , 1.00001 )
        self.HiggsSamples["tth"] = DatasetInfo("tth" , "../../signals/13May/out_tth_syst.root", "cms_hgg_13tev", "RVtth_mh125",  "2dPlots.root",EffPlotName , 0.99999 , 1.00001 )
        self.HiggsSamples["vh"]  = DatasetInfo("vh" , "../../signals/13May/out_vh_syst.root", "cms_hgg_13tev", "RVvh_mh125" ,  "2dPlots.root" , EffPlotName, 0.99999 , 1.00001 )
...
for kv in Kvs :
    ...
    for kf in KvKfs[kv]:
        ...
        fRun.write("cd datacards/6June/%s\n" % (dirname) )
        ...
        submitLx.write( "cd %s\n" % (dirname) )
        submitLx.write( "bsub -J %s -o out -q 8nh run.sh\n" % dirname )
        submitLx.write( "cd ..\n" )

...
class BinDatacard :
    def __init__(self, BinName  , EffPlotName = None , bkgRate = 1. ):
        ...
        self.HiggsSamples["thq"] = DatasetInfo("thq" , "../../signals/14August/out_ctcv_thq_syst.root", "ctcv", "RVthq_mh125" , "2dPlots.root" ,   EffPlotName, 0.99999 , 1.00001 , self.Cut )
        self.HiggsSamples["thw"] = DatasetInfo("thw" , "../../signals/14August/out_ctcv_thw_syst.root", "ctcv", "RVthw_mh125" ,  "2dPlots.root" ,  EffPlotName, 0.99999 , 1.00001 , self.Cut )
        self.HiggsSamples["tth"] = DatasetInfo("tth" , "../../signals/14August/out_tth_syst.root", "cms_hgg_13TeV", "RVtth_mh125",  "2dPlots.root",EffPlotName , 0.99999 ,1.00001 , self.Cut )
...
for kvkt in AllCtOverCVs:
    ...
    fRun.write("cd /eos/user/h/hbakhshi/Personal/Projects/tHq/Analyzer/FinalFit/datacards/14Aug/%s\n" % (dirname) )

...
class BinDatacard :
    def __init__(self, BinName  , EffPlotName = None , bkgRate = 1. ):
        ...
        self.HiggsSamples["thq"] = DatasetInfo("thq" , "../../signals/22June/out_ctcv_thq_syst.root", "ctcv", "RVthq_mh125" , "2dPlots.root" ,   EffPlotName, 0.99999 , 1.00001 , self.Cut )
        self.HiggsSamples["thw"] = DatasetInfo("thw" , "../../signals/22June/out_ctcv_thw_syst.root", "ctcv", "RVthw_mh125" ,  "2dPlots.root" ,  EffPlotName, 0.99999 , 1.00001 , self.Cut )
        self.HiggsSamples["tth"] = DatasetInfo("tth" , "../../signals/22June/out_tth_syst.root", "cms_hgg_13TeV", "RVtth_mh125",  "2dPlots.root",EffPlotName , 0.99999 ,1.00001 , self.Cut )
        self.HiggsSamples["vh"]  = DatasetInfo("vh" , "../../signals/22June/out_vh_syst.root", "cms_hgg_13TeV", "RVvh_mh125" ,  "2dPlots.root" , EffPlotName, 0.99999 , 1.00001 , self.Cut )
...
for kvkt in AllCtOverCVs:
    ...
    fRun.write("cd datacards/28June/%s\n" % (dirname) )

...
def usage():
    ...
    print "  -i | --inputdir  : name of input ROOT file (default: '%s')" % DEFAULT_INFNAME
    ...
    print "  -g | --gui        : open only the GUI without running the factory"
    print " "
...
def main():
    ...
    try:
        ...
        shortopts  = "m:i:t:o:vhg?"
        longopts   = ["methods=", "inputdir=", "inputtrees=", "outputfile=", "verbose", "help", "usage" , "gui"]
    ...
    factory = TMVA.Factory( "TMVAClassification_"+ extention, outputFile, 
    ...
    factory.AddVariable( "abs(jprimeeta)","jprimeeta" , "" , 'F' )
    factory.AddVariable( "met.pt", "met", "", 'F' )
    factory.AddVariable( "lepton.charge","LepCharge" , "" , 'I' )
    factory.AddVariable( "eventshapes.aplanarity" , "aplanarity" , "" , 'F' )
    factory.AddVariable( "foxwolf1.ONE" , "fwf1ONE" , "" , 'F' )

    # You can add so-called "Spectator variables", which are not used in the MVA training, 
    # but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the 
    # input variables, the response values of all trained MVAs, and the spectator variables
    
    # factory.AddSpectator( "Top.topM" , "topmass" ,  'F' )
    # factory.AddSpectator( "abs(THReco.THDPhi)" , "thDPhi" ,  'F' )
    # factory.AddSpectator( "abs(Top.JPrime)" , "abs_thJPrime" ,  'F' )
    # factory.AddSpectator( "THReco.THDR" , "thDR" ,  'F' )
    # factory.AddSpectator( "Top.THDEta" , "thDEta" ,  'F' )
    # factory.AddSpectator( "Top.CosTheta" , "thCosTheta" ,  'F' )
    # factory.AddSpectator( "Top.CosThetaStar" , "CosThetaStar" ,  'F' )
    # factory.AddSpectator( "nLbJets", "nLbJets", 'I' ) 
    
    # factory.AddSpectator( "eventshapes.isotropy" , "isotropy" ,  'F' )
    # factory.AddSpectator( "eventshapes.C" , "C" ,  'F' )
    # factory.AddSpectator( "eventshapes.D" , "D" ,  'F' )
    # factory.AddSpectator( "eventshapes.circularity" , "circularity" ,  'F' )
    # factory.AddSpectator( "eventshapes.sphericity" , "sphericity" ,  'F' )

    # factory.AddSpectator( "eventshapesMET.isotropy" , "isotropy" ,  'F' )
    # factory.AddSpectator( "eventshapesMET.aplanarity" , "aplanarity" ,  'F' )
    # factory.AddSpectator( "eventshapesMET.C" , "C" ,  'F' )
    # factory.AddSpectator( "eventshapesMET.D" , "D" ,  'F' )
    # factory.AddSpectator( "eventshapesMET.circularity" , "circularity" ,  'F' )
    # factory.AddSpectator( "eventshapesMET.sphericity" , "sphericity" ,  'F' )

    # factory.AddSpectator( "foxwolf1.PT" , "fwf1PT" ,  'F' )
    # factory.AddSpectator( "foxwolf1.ETA" , "fwf1ETA" ,  'F' )
    # factory.AddSpectator( "foxwolf1.PSUM" , "fwf1PSUM" ,  'F' )
    # factory.AddSpectator( "foxwolf1.PZ" , "fwf1PZ" ,  'F' )

    # factory.AddSpectator( "foxwolf2.SHAT" , "fwf2SHAT" ,  'F' )
    # factory.AddSpectator( "foxwolf2.PT" , "fwf2PT" ,  'F' )
    # factory.AddSpectator( "foxwolf2.ETA" , "fwf2ETA" ,  'F' )
    # factory.AddSpectator( "foxwolf2.PSUM" , "fwf2PSUM" ,  'F' )
    # factory.AddSpectator( "foxwolf2.PZ" , "fwf2PZ" ,  'F' )
    # factory.AddSpectator( "foxwolf2.ONE" , "fwf2ONE" ,  'F' )


    # factory.AddSpectator( "foxwolf1Met.PT" , "fwf1MetPT" ,  'F' )
    # factory.AddSpectator( "foxwolf1Met.ETA" , "fwf1MetETA" ,  'F' )
    # factory.AddSpectator( "foxwolf1Met.PSUM" , "fwf1MetPSUM" ,  'F' )
    # factory.AddSpectator( "foxwolf1Met.PZ" , "fwf1MetPZ" ,  'F' )
    # factory.AddSpectator( "foxwolf1Met.ONE" , "fwf1MetONE" ,  'F' )

    # factory.AddSpectator( "foxwolf2Met.SHAT" , "fwf2MetSHAT" ,  'F' )
    # factory.AddSpectator( "foxwolf2Met.PT" , "fwf2MetPT" ,  'F' )
    # factory.AddSpectator( "foxwolf2Met.ETA" , "fwf2MetETA" ,  'F' )
    # factory.AddSpectator( "foxwolf2Met.PSUM" , "fwf2MetPSUM" ,  'F' )
    # factory.AddSpectator( "foxwolf2Met.PZ" , "fwf2MetPZ" ,  'F' )
    # factory.AddSpectator( "foxwolf2Met.ONE" , "fwf2MetONE" ,  'F' )    
    ...
    Cuts = {"DiG":"1",
        ...
        "exactlyOneMu" : "(LeptonType == 1 || LeptonType ==2)" ,
        "nonIsoMu" : "nMuons == 100" ,
        "met" : "met > 30" }
    ...
    if "Likelihood" in mlist:
        factory.BookMethod( TMVA.Types.kLikelihood, "Likelihood",
                            "H:!V:!TransformOutput:PDFInterpol=Spline2:NSmoothSig[0]=20:NSmooth=1:NAvEvtPerBin=50" )       #NSmoothBkg[0]=20:NSmoothBkg[1]=10:
   ...
   # Multi-dimensional likelihood estimator using self-adapting phase-space binning
    ...
    if "BDT" in mlist:
        factory.BookMethod( TMVA.Types.kBDT, "BDT",
                            "!H:!V:NTrees=850:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=CrossEntropy:nCuts=20:PruneMethod=NoPruning" )

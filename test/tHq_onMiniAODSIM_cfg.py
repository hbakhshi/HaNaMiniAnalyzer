...
if options.sync == 0 :
    from Samples76tHq.MiniAODSamples import MiniAOD76Samples as samples
...
process.triggerSelection.triggerConditions.extend( process.tHq.HLT.HLT_To_Or )

process.pMicroAOD = cms.Path(process.triggerSelection * process.flashggMicroAODSequence * process.flashggSeq)
...
process.outp1.outputCommands += cms.untracked.vstring("keep *_flashgg*_*_*")
